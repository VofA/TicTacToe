 ...
 */
  ...
  class basic_streambuf : public std::streambuf, private noncopyable {
     ...
     * ConstBufferSequence requirements, representing all character arrays in
     * the input sequence.
     *
    ...
    /**
     * Appends @c n characters from the start of the output sequence to the
     * input sequence. The beginning of the output sequence is advanced by @c n
     * characters.
     *
