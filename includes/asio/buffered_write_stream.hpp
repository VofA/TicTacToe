...
namespace asio {
  ...
  /**
   * The buffered_write_stream class template can be used to add buffering to
   * the synchronous and asynchronous write operations of a stream.
   *
   * @par Thread Safety
  ...
  class buffered_write_stream : private noncopyable {
    public:
    ...
    explicit buffered_write_stream(Arg &a)
        : next_layer_(a), storage_(default_buffer_size) {
    }

    /// Construct, passing the specified argument to initialise the next layer.
    template <typename Arg>
    buffered_write_stream(Arg &a, std::size_t buffer_size)
        : next_layer_(a), storage_(buffer_size) {
    }
