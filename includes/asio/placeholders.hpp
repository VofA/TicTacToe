...
namespace asio {
  namespace placeholders {
    ...
    /// An argument placeholder, for use with boost::bind(), that corresponds to
    /// the bytes_transferred argument of a handler for asynchronous functions
    /// such as asio::basic_stream_socket::async_write_some or
    /// asio::async_write.
    ...
    /// An argument placeholder, for use with boost::bind(), that corresponds to
    /// the signal_number argument of a handler for asynchronous functions such
    /// as asio::signal_set::async_wait.
    ...
    namespace {
      boost::arg<1> &error = asio::placeholders::detail::placeholder<1>::get();
