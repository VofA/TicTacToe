...
namespace asio {
...
#endif
  {
    ...
    explicit seq_packet_socket_service(asio::io_context &io_context)
        : asio::detail::service_base<seq_packet_socket_service<Protocol>>(
              io_context)
    ...
    friend class seq_packet_socket_service;
    ...
    void converting_move_construct(
        ...
        typename seq_packet_socket_service<Protocol1>::implementation_type
            &other_impl,
    ...
    std::size_t receive(implementation_type &impl,
                        ...
                        asio::error_code &ec) {
      return service_impl_.receive_with_flags(
          impl, buffers, in_flags, out_flags, ec);
    }
    ...
    async_receive(implementation_type &impl,
      ...
      service_impl_.async_receive_with_flags(
          impl, buffers, in_flags, out_flags, init.completion_handler);
