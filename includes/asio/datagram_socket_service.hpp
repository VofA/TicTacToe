...
namespace asio {
...
#endif
  {
    ...
    friend class datagram_socket_service;
    ...
    void converting_move_construct(
        ...
        typename datagram_socket_service<Protocol1>::implementation_type
            &other_impl,
    ...
    ASIO_SYNC_OP_VOID close(implementation_type &impl, asio::error_code &ec) {
    ...
    ASIO_SYNC_OP_VOID cancel(implementation_type &impl, asio::error_code &ec) {
    ...
    ASIO_SYNC_OP_VOID
    non_blocking(implementation_type &impl, bool mode, asio::error_code &ec) {
    ...
    async_send_to(implementation_type &impl,
      ...
      service_impl_.async_send_to(
          impl, buffers, destination, flags, init.completion_handler);
    ...
    async_receive(implementation_type &impl,
      ...
      service_impl_.async_receive(
          impl, buffers, flags, init.completion_handler);
    ...
    std::size_t receive_from(implementation_type &impl,
                             ...
                             socket_base::message_flags flags,
                             asio::error_code &ec) {
      return service_impl_.receive_from(
          impl, buffers, sender_endpoint, flags, ec);
    }
    ...
    async_receive_from(implementation_type &impl,
      ...
      service_impl_.async_receive_from(
          impl, buffers, sender_endpoint, flags, init.completion_handler);
