...
namespace asio {
  ...
  /// An object of type @c executor_work_guard controls ownership of executor
  /// work within a scope.
  ...
  make_work_guard(
      ...
      typename enable_if<!is_executor<T>::value &&
                         !is_convertible<T &, execution_context &>::value>::type
          * = 0) {
  ...
  inline executor_work_guard<typename associated_executor<
      T,
  ...
  make_work_guard(
      ...
      typename enable_if<
          ...
          is_convertible<ExecutionContext &, execution_context &>::value>::type
          * = 0) {
    return executor_work_guard<typename associated_executor<
        T,
        typename ExecutionContext::executor_type>::type>(
