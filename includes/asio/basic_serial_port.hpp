...
namespace asio {
  ...
  class basic_serial_port : public basic_io_object<SerialPortService>,
     ...
     * port.
     */
    explicit basic_serial_port(asio::io_context &io_context, const char *device)
        : basic_io_object<SerialPortService>(io_context) {
      asio::error_code ec;
     ...
     * if constructed using the @c basic_serial_port(io_context&) constructor.
     */
