...
namespace asio {
  namespace windows {
    ...
    class basic_handle : public basic_io_object<HandleService> {
       ...
       *
       * @param other The other basic_handle object from which the move will
       * occur.
       *
       * @note Following the move, the moved-from object is in the same state as
       * if constructed using the @c basic_handle(io_context&) constructor.
       */
       ...
       * layers. Since a basic_handle cannot contain any further layers, it
       ...
       * of layers. Since a basic_handle cannot contain any further layers, it
       * simply returns a reference to itself.
       *
