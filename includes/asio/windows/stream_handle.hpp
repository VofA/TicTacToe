...
namespace asio {
  namespace windows {
     ...
     * SyncWriteStream.
     */
    class stream_handle : public overlapped_handle {
      public:
       ...
       *
       * @param io_context The io_context object that the stream handle will use
      ...
      /**
       * This constructor creates a stream handle object to hold an existing
       * native handle.
       *
       * @param io_context The io_context object that the stream handle will use
       * to dispatch handlers for any asynchronous operations performed on the
       ...
       * if constructed using the @c stream_handle(io_context&) constructor.
       */
