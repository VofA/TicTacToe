...
namespace asio {
  namespace windows {
    ...
    /// overlapped I/O.
    /**
     * The windows::overlapped_handle class provides the ability to wrap a
     * Windows handle. The underlying object referred to by the handle must
     ...
     */
    class overlapped_handle : ASIO_SVC_ACCESS basic_io_object<ASIO_SVC_T> {
      public:
      ...
      /**
       * This constructor creates a handle object to hold an existing native
       * handle.
       *
       * @param io_context The io_context object that the handle will use to
       * dispatch handlers for any asynchronous operations performed on the
       ...
       *
       * @param other The other overlapped_handle object from which the move
       * will occur.
       *
       * @note Following the move, the moved-from object is in the same state as
       * if constructed using the @c overlapped_handle(io_context&) constructor.
       */
       ...
       * layers. Since an overlapped_handle cannot contain any further layers,
       ...
       * of layers. Since an overlapped_handle cannot contain any further
       * layers, it simply returns a reference to itself.
       *
      ...
      /**
       * This function destroys the handle, cancelling any outstanding
       * asynchronous wait operations associated with the handle as if by
       * calling @c cancel.
       */
      ~overlapped_handle() {
      }
