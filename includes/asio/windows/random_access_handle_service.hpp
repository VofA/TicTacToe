  ...
  namespace windows {
...
#endif
    {
      ...
      explicit random_access_handle_service(asio::io_context &io_context)
          : asio::detail::service_base<random_access_handle_service>(io_context)
      ...
      std::size_t write_some_at(implementation_type &impl,
                                uint64_t offset,
      ...
      async_write_some_at(implementation_type &impl,
        ...
        service_impl_.async_write_some_at(
            impl, offset, buffers, init.completion_handler);
      ...
      std::size_t read_some_at(implementation_type &impl,
                               uint64_t offset,
      ...
      async_read_some_at(implementation_type &impl,
        ...
        service_impl_.async_read_some_at(
            impl, offset, buffers, init.completion_handler);
