...
namespace asio {
  namespace windows {
    ...
    /**
     * The windows::basic_random_access_handle class template provides
     * asynchronous and blocking random-access handle functionality.
     *
     * @par Thread Safety
    ...
    class basic_random_access_handle
       ...
       * it.
       *
       * @param io_context The io_context object that the random-access handle
      ...
      /**
       * This constructor creates a random-access handle object to hold an
      ...
      /**
       * This constructor moves a random-access handle from one object to
       * another.
       *
       ...
       * if constructed using the @c basic_random_access_handle(io_context&)
       * constructor.
       */
      ...
      /**
       * This assignment operator moves a random-access handle from one object
       * to another.
       *
       * @param other The other basic_random_access_handle object from which the
       * move will occur.
      ...
      operator=(basic_random_access_handle &&other) {
       ...
       * peer.
       *
       * @note The write_some_at operation may not write all of the data.
       * Consider using the @ref write_at function if you need to ensure that
       ...
       * Consider using the @ref async_write_at function if you need to ensure
       ...
       * of bytes. Consider using the @ref read_at function if you need to
      ...
      /**
       * This function is used to asynchronously read data from the
       * random-access handle. The function call always returns immediately.
       *
       * @param offset The offset at which the data will be read.
       *
       * @param buffers One or more buffers into which the data will be read.
       ...
       * bytes. Consider using the @ref async_read_at function if you need to
       * ensure that the requested amount of data is read before the
