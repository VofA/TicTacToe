...
namespace asio {
  namespace windows {
    ...
    class basic_object_handle : public basic_handle<ObjectHandleService> {
      public:
      /// The native representation of a handle.
      typedef
          typename ObjectHandleService::native_handle_type native_handle_type;
       ...
       *
       * @param other The other basic_object_handle object from which the move
       * will occur.
       *
       * @note Following the move, the moved-from object is in the same state as
       * if constructed using the @c basic_object_handle(io_context&)
       * constructor.
       */
