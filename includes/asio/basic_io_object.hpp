 ...
 */
  ...
  class basic_io_object<IoObjectService, true> {
    ...
    basic_io_object(
      ...
      service_->converting_move_construct(
          implementation_, other_service, other_implementation);
    }
    ...
    basic_io_object &operator=(basic_io_object &&other) {
      service_->move_assign(
          implementation_, *other.service_, other.implementation_);
