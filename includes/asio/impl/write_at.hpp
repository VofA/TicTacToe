...
namespace asio {
  ...
  namespace detail {
    ...
    std::size_t
    write_at_buffer_sequence(SyncRandomAccessWriteDevice &d,
                             uint64_t offset,
      ...
      while (!tmp.empty()) {
        if (std::size_t max_size = detail::adapt_completion_condition_result(
          ...
          tmp.consume(d.write_some_at(
              offset + tmp.total_consumed(), tmp.prepare(max_size), ec));
        } else
          break;
      }
  ...
  std::size_t write_at(SyncRandomAccessWriteDevice &d,
                       ...
                       CompletionCondition completion_condition,
                       asio::error_code &ec) {
    return detail::write_at_buffer_sequence(
        d,
        offset,
        buffers,
  ...
  inline std::size_t write_at(SyncRandomAccessWriteDevice &d,
    ...
    std::size_t bytes_transferred =
        write_at(d, offset, buffers, transfer_all(), ec);
  ...
  inline std::size_t write_at(SyncRandomAccessWriteDevice &d,
    ...
    asio::error_code ec;
    std::size_t bytes_transferred =
        write_at(d, offset, buffers, completion_condition, ec);
    asio::detail::throw_error(ec, "write_at");
    return bytes_transferred;
  }
  ...
  std::size_t write_at(SyncRandomAccessWriteDevice &d,
                       ...
                       asio::error_code &ec) {
    std::size_t bytes_transferred =
        write_at(d, offset, b.data(), completion_condition, ec);
  ...
  inline std::size_t write_at(SyncRandomAccessWriteDevice &d,
    ...
    asio::error_code ec;
    std::size_t bytes_transferred =
        write_at(d, offset, b, completion_condition, ec);
    asio::detail::throw_error(ec, "write_at");
    return bytes_transferred;
  }
  ...
  namespace detail {
    ...
    class write_at_op : detail::base_from_completion_cond<CompletionCondition> {
      public:
      ...
      void operator()(const asio::error_code &ec,
        ...
        switch (start_ = start) {
          case 1:
            ...
            do {
              device_.async_write_some_at(offset_ + buffers_.total_consumed(),
                                          buffers_.prepare(max_size),
    ...
    asio_handler_allocate(std::size_t size,
                          write_at_op<AsyncRandomAccessWriteDevice,
                                      ConstBufferSequence,
                                      ConstBufferIterator,
                                      CompletionCondition,
    ...
    template <typename AsyncRandomAccessWriteDevice,
              ...
              typename WriteHandler>
    inline bool
    asio_handler_is_continuation(write_at_op<AsyncRandomAccessWriteDevice,
                                             ConstBufferSequence,
                                             ConstBufferIterator,
                                             CompletionCondition,
                                             WriteHandler> *this_handler) {
    ...
    template <typename AsyncRandomAccessWriteDevice,
              ...
              typename WriteHandler>
    inline void
    start_write_at_buffer_sequence_op(AsyncRandomAccessWriteDevice &d,
                                      uint64_t offset,
                                      const ConstBufferSequence &buffers,
                                      const ConstBufferIterator &,
                                      CompletionCondition completion_condition,
  ...
  template <typename AsyncRandomAccessWriteDevice,
            ...
            typename WriteHandler,
            typename Allocator>
  struct associated_allocator<detail::write_at_op<AsyncRandomAccessWriteDevice,
                                                  ConstBufferSequence,
                                                  ConstBufferIterator,
                                                  CompletionCondition,
                                                  WriteHandler>,
    ...
    static type get(const detail::write_at_op<AsyncRandomAccessWriteDevice,
                                              ConstBufferSequence,
                                              ConstBufferIterator,
                                              CompletionCondition,
                                              WriteHandler> &h,
  ...
  template <typename AsyncRandomAccessWriteDevice,
            ...
            typename WriteHandler,
            typename Executor>
  struct associated_executor<detail::write_at_op<AsyncRandomAccessWriteDevice,
                                                 ConstBufferSequence,
                                                 ConstBufferIterator,
                                                 CompletionCondition,
                                                 WriteHandler>,
  ...
  inline ASIO_INITFN_RESULT_TYPE(WriteHandler,
    ...
    detail::start_write_at_buffer_sequence_op(
        d,
        offset,
        buffers,
        asio::buffer_sequence_begin(buffers),
  ...
  namespace detail {
    ...
    class write_at_streambuf_op {
      public:
      write_at_streambuf_op(asio::basic_streambuf<Allocator> &streambuf,
                            WriteHandler &handler)
      ...
      write_at_streambuf_op(const write_at_streambuf_op &other)
          : streambuf_(other.streambuf_), handler_(other.handler_) {
      }
    ...
    make_write_at_streambuf_op(asio::basic_streambuf<Allocator> &b,
                               WriteHandler handler) {
  ...
  struct associated_allocator<
    ...
    static type
    get(const detail::write_at_streambuf_op<Allocator, WriteHandler> &h,
