...
namespace asio {
  ...
  template <typename SyncReadStream,
            ...
            typename CompletionCondition>
  std::size_t
  read(SyncReadStream &s,
       const MutableBufferSequence &buffers,
       CompletionCondition completion_condition,
       asio::error_code &ec,
       typename enable_if<
           is_mutable_buffer_sequence<MutableBufferSequence>::value>::type *) {
    return detail::read_buffer_sequence(s,
                                        buffers,
  ...
  std::size_t read(SyncReadStream &s,
                   ...
                   CompletionCondition completion_condition,
                   asio::error_code &ec,
                   typename enable_if<is_dynamic_buffer<
                       typename decay<DynamicBuffer>::type>::value>::type *) {
    ...
    while (bytes_available > 0) {
      std::size_t bytes_transferred =
          s.read_some(b.prepare(bytes_available), ec);
  ...
  read(SyncReadStream &s,
       ASIO_MOVE_ARG(DynamicBuffer) buffers,
       typename enable_if<
           is_dynamic_buffer<typename decay<DynamicBuffer>::type>::value>::type
           *) {
    asio::error_code ec;
    std::size_t bytes_transferred =
        read(s, ASIO_MOVE_CAST(DynamicBuffer)(buffers), transfer_all(), ec);
    asio::detail::throw_error(ec, "read");
    return bytes_transferred;
  }
  ...
  read(SyncReadStream &s,
       ...
       typename enable_if<
           is_dynamic_buffer<typename decay<DynamicBuffer>::type>::value>::type
           *) {
    return read(s, ASIO_MOVE_CAST(DynamicBuffer)(buffers), transfer_all(), ec);
  }
  ...
  read(SyncReadStream &s,
       ...
       typename enable_if<
           ...
           *) {
    asio::error_code ec;
    std::size_t bytes_transferred = read(
        s, ASIO_MOVE_CAST(DynamicBuffer)(buffers), completion_condition, ec);
    asio::detail::throw_error(ec, "read");
    return bytes_transferred;
  }
  ...
  namespace detail {
    ...
    class read_op : detail::base_from_completion_cond<CompletionCondition> {
      public:
      ...
      void operator()(const asio::error_code &ec,
        ...
        switch (start_ = start) {
          case 1:
            max_size =
                this->check_for_completion(ec, buffers_.total_consumed());
            do {
    ...
    template <typename AsyncReadStream,
              ...
              typename ReadHandler>
    inline bool
    asio_handler_is_continuation(read_op<AsyncReadStream,
                                         MutableBufferSequence,
                                         MutableBufferIterator,
                                         CompletionCondition,
                                         ReadHandler> *this_handler) {
    ...
    template <typename AsyncReadStream,
              ...
              typename ReadHandler>
    inline void
    start_read_buffer_sequence_op(AsyncReadStream &stream,
                                  const MutableBufferSequence &buffers,
                                  const MutableBufferIterator &,
                                  CompletionCondition completion_condition,
                                  ReadHandler &handler) {
      detail::read_op<AsyncReadStream,
                      MutableBufferSequence,
                      MutableBufferIterator,
                      CompletionCondition,
                      ReadHandler>(stream,
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Allocator>
  struct associated_allocator<detail::read_op<AsyncReadStream,
                                              MutableBufferSequence,
                                              MutableBufferIterator,
                                              CompletionCondition,
                                              ReadHandler>,
    ...
    static type get(const detail::read_op<AsyncReadStream,
                                          MutableBufferSequence,
                                          MutableBufferIterator,
                                          CompletionCondition,
                                          ReadHandler> &h,
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Executor>
  struct associated_executor<detail::read_op<AsyncReadStream,
                                             MutableBufferSequence,
                                             MutableBufferIterator,
                                             CompletionCondition,
                                             ReadHandler>,
  ...
  inline ASIO_INITFN_RESULT_TYPE(ReadHandler,
      ...
      async_read(AsyncReadStream &s,
                 ...
                 typename enable_if<is_mutable_buffer_sequence<
                     MutableBufferSequence>::value>::type *) {
    ...
    detail::start_read_buffer_sequence_op(s,
                                          buffers,
                                          asio::buffer_sequence_begin(buffers),
                                          completion_condition,
  ...
  namespace detail {
            ...
            for (;;) {
              ...
              default:
                ...
                bytes_available = std::min<std::size_t>(
                    ...
                    std::min<std::size_t>(
                        max_size, buffers_.max_size() - buffers_.size()));
    ...
    asio_handler_allocate(std::size_t size,
                          read_dynbuf_op<AsyncReadStream,
                                         DynamicBuffer,
                                         CompletionCondition,
                                         ReadHandler> *this_handler) {
      return asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
    ...
    template <typename AsyncReadStream,
              ...
              typename ReadHandler>
    inline bool
    asio_handler_is_continuation(read_dynbuf_op<AsyncReadStream,
                                                DynamicBuffer,
                                                CompletionCondition,
                                                ReadHandler> *this_handler) {
      return this_handler->start_ == 0
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Allocator>
  struct associated_allocator<detail::read_dynbuf_op<AsyncReadStream,
                                                     DynamicBuffer,
                                                     CompletionCondition,
                                                     ReadHandler>,
                              Allocator> {
    ...
    static type get(const detail::read_dynbuf_op<AsyncReadStream,
                                                 DynamicBuffer,
                                                 CompletionCondition,
                                                 ReadHandler> &h,
                    const Allocator &a = Allocator()) ASIO_NOEXCEPT {
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Executor>
  struct associated_executor<detail::read_dynbuf_op<AsyncReadStream,
                                                    DynamicBuffer,
                                                    CompletionCondition,
                                                    ReadHandler>,
                             Executor> {
