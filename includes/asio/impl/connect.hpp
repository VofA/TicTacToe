...
namespace asio {
  ...
  namespace detail {
    ...
    inline typename Protocol::endpoint
    deref_connect_result(Iterator iter, asio::error_code &ec) {
    ...
    inline Iterator call_connect_condition(
        ConnectCondition &connect_condition,
        const asio::error_code &ec,
        Iterator next,
        Iterator end,
        typename enable_if<is_legacy_connect_condition<ConnectCondition,
                                                       Iterator>::value>::type
            * = 0) {
      if (next != end)
  ...
  typename Protocol::endpoint connect(
      ...
      typename enable_if<is_endpoint_sequence<EndpointSequence>::value>::type
          *) {
    asio::error_code ec;
  ...
  Iterator
  connect(basic_socket<Protocol ASIO_SVC_TARG> &s,
          Iterator begin,
  ...
  connect(basic_socket<Protocol ASIO_SVC_TARG> &s,
          ...
          typename enable_if<!is_endpoint_sequence<Iterator>::value>::type *) {
    return connect(
        s, begin, Iterator(), detail::default_connect_condition(), ec);
  }
  ...
  typename Protocol::endpoint connect(
      ...
      typename enable_if<is_endpoint_sequence<EndpointSequence>::value>::type
          *) {
    asio::error_code ec;
    typename Protocol::endpoint result =
        connect(s, endpoints, connect_condition, ec);
    asio::detail::throw_error(ec, "connect");
    return result;
  }
  ...
  typename Protocol::endpoint connect(
      ...
      typename enable_if<is_endpoint_sequence<EndpointSequence>::value>::type
          *) {
    return detail::deref_connect_result<Protocol>(
        connect(s, endpoints.begin(), endpoints.end(), connect_condition, ec),
        ec);
  }
  ...
  namespace detail {
    ...
    class base_from_connect_condition {
      ...
      void check_condition(const asio::error_code &ec,
                           ...
                           Iterator &end) {
        iter =
            detail::call_connect_condition(connect_condition_, ec, iter, end);
      }
    ...
    asio_handler_allocate(std::size_t size,
                          range_connect_op<Protocol ASIO_SVC_TARG,
                                           EndpointSequence,
                                           ConnectCondition,
                                           RangeConnectHandler> *this_handler) {
    ...
    template <typename Function,
              typename Protocol ASIO_SVC_TPARAM,
              typename EndpointSequence,
              typename ConnectCondition,
              typename RangeConnectHandler>
    inline void
            ...
            for (;;) {
              ...
              if (iter_ != end_) {
                ...
                socket_.async_connect(
                    *iter_, ASIO_MOVE_CAST(iterator_connect_op)(*this));
                return;
              }
    ...
    inline void *asio_handler_allocate(
        std::size_t size,
        iterator_connect_op<Protocol ASIO_SVC_TARG,
                            Iterator,
                            ConnectCondition,
                            IteratorConnectHandler> *this_handler) {
      return asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
    }
  ...
  template <typename Protocol ASIO_SVC_TPARAM,
            ...
            typename RangeConnectHandler,
            typename Allocator>
  struct associated_allocator<detail::range_connect_op<Protocol ASIO_SVC_TARG,
                                                       EndpointSequence,
                                                       ConnectCondition,
                                                       RangeConnectHandler>,
                              Allocator> {
    typedef typename associated_allocator<RangeConnectHandler, Allocator>::type
        type;

    static type get(const detail::range_connect_op<Protocol ASIO_SVC_TARG,
                                                   EndpointSequence,
                                                   ConnectCondition,
                                                   RangeConnectHandler> &h,
                    const Allocator &a = Allocator()) ASIO_NOEXCEPT {
      return associated_allocator<RangeConnectHandler, Allocator>::get(
          h.handler_, a);
    }
  };
  ...
  template <typename Protocol ASIO_SVC_TPARAM,
            ...
            typename RangeConnectHandler,
            typename Executor>
  struct associated_executor<detail::range_connect_op<Protocol ASIO_SVC_TARG,
                                                      EndpointSequence,
                                                      ConnectCondition,
                                                      RangeConnectHandler>,
                             Executor> {
    typedef
        typename associated_executor<RangeConnectHandler, Executor>::type type;
    ...
    static type get(const detail::range_connect_op<Protocol ASIO_SVC_TARG,
      ...
      return associated_executor<RangeConnectHandler, Executor>::get(h.handler_,
                                                                     ex);
    }
  };
  ...
  struct associated_allocator<
      detail::iterator_connect_op<Protocol ASIO_SVC_TARG,
                                  Iterator,
                                  ConnectCondition,
                                  IteratorConnectHandler>,
      Allocator> {
    typedef
        typename associated_allocator<IteratorConnectHandler, Allocator>::type
            type;

    static type
    get(const detail::iterator_connect_op<Protocol ASIO_SVC_TARG,
                                          Iterator,
                                          ConnectCondition,
                                          IteratorConnectHandler> &h,
        const Allocator &a = Allocator()) ASIO_NOEXCEPT {
      return associated_allocator<IteratorConnectHandler, Allocator>::get(
          h.handler_, a);
    }
  };
  ...
  struct associated_executor<
      detail::iterator_connect_op<Protocol ASIO_SVC_TARG,
                                  ...
                                  IteratorConnectHandler>,
      Executor> {
    typedef typename associated_executor<IteratorConnectHandler, Executor>::type
        type;
    ...
    get(const detail::iterator_connect_op<Protocol ASIO_SVC_TARG,
                                          ...
                                          IteratorConnectHandler> &h,
        const Executor &ex = Executor()) ASIO_NOEXCEPT {
      return associated_executor<IteratorConnectHandler, Executor>::get(
          h.handler_, ex);
    }
  };
  ...
  inline ASIO_INITFN_RESULT_TYPE(RangeConnectHandler,
    ...
    detail::range_connect_op<
        Protocol ASIO_SVC_TARG,
        EndpointSequence,
        detail::default_connect_condition,
  ...
  inline ASIO_INITFN_RESULT_TYPE(IteratorConnectHandler,
    ...
    async_completion<IteratorConnectHandler, void(asio::error_code, Iterator)>
        init(handler);
  ...
  inline ASIO_INITFN_RESULT_TYPE(RangeConnectHandler,
    ...
    detail::range_connect_op<
        ...
        ASIO_HANDLER_TYPE(RangeConnectHandler,
                          void(asio::error_code, typename Protocol::endpoint))>(
        s, endpoints, connect_condition, init.completion_handler)(
        asio::error_code(), 1);
  ...
  inline ASIO_INITFN_RESULT_TYPE(IteratorConnectHandler,
    ...
    detail::iterator_connect_op<Protocol ASIO_SVC_TARG,
                                ...
                                ASIO_HANDLER_TYPE(
                                    IteratorConnectHandler,
                                    void(asio::error_code, Iterator))>(
        s, begin, Iterator(), connect_condition, init.completion_handler)(
        asio::error_code(), 1);
  ...
  inline ASIO_INITFN_RESULT_TYPE(IteratorConnectHandler,
    ...
    detail::iterator_connect_op<Protocol ASIO_SVC_TARG,
                                ...
                                ASIO_HANDLER_TYPE(
                                    IteratorConnectHandler,
                                    void(asio::error_code, Iterator))>(
        s, begin, end, connect_condition, init.completion_handler)(
        asio::error_code(), 1);
