...
namespace asio {
  ...
  template <typename SyncWriteStream,
            ...
            typename CompletionCondition>
  inline std::size_t
  write(SyncWriteStream &s,
        const ConstBufferSequence &buffers,
        CompletionCondition completion_condition,
        asio::error_code &ec,
        typename enable_if<
            is_const_buffer_sequence<ConstBufferSequence>::value>::type *) {
    return detail::write_buffer_sequence(s,
                                         buffers,
  ...
  std::size_t write(SyncWriteStream &s,
    ...
    std::size_t bytes_transferred =
        write(s, b.data(), completion_condition, ec);
  ...
  write(SyncWriteStream &s,
    ...
    asio::error_code ec;
    std::size_t bytes_transferred =
        write(s, ASIO_MOVE_CAST(DynamicBuffer)(buffers), transfer_all(), ec);
    asio::detail::throw_error(ec, "write");
    return bytes_transferred;
  }
  ...
  write(SyncWriteStream &s,
        ...
        typename enable_if<
            is_dynamic_buffer<typename decay<DynamicBuffer>::type>::value>::type
            *) {
    return write(s, ASIO_MOVE_CAST(DynamicBuffer)(buffers), transfer_all(), ec);
  }
  ...
  inline std::size_t write(SyncWriteStream &s,
                           ...
                           asio::error_code &ec) {
    return write(
        s, basic_streambuf_ref<Allocator>(b), completion_condition, ec);
  }
  ...
  namespace detail {
    ...
    class write_op : detail::base_from_completion_cond<CompletionCondition> {
      public:
    ...
    template <typename AsyncWriteStream,
              ...
              typename WriteHandler>
    inline bool
    asio_handler_is_continuation(write_op<AsyncWriteStream,
                                          ConstBufferSequence,
                                          ConstBufferIterator,
                                          CompletionCondition,
                                          WriteHandler> *this_handler) {
    ...
    template <typename AsyncWriteStream,
              ...
              typename WriteHandler>
    inline void
    start_write_buffer_sequence_op(AsyncWriteStream &stream,
                                   const ConstBufferSequence &buffers,
                                   const ConstBufferIterator &,
                                   CompletionCondition completion_condition,
                                   WriteHandler &handler) {
  ...
  template <typename AsyncWriteStream,
            ...
            typename WriteHandler,
            typename Allocator>
  struct associated_allocator<detail::write_op<AsyncWriteStream,
                                               ConstBufferSequence,
                                               ConstBufferIterator,
                                               CompletionCondition,
                                               WriteHandler>,
    ...
    static type get(const detail::write_op<AsyncWriteStream,
                                           ConstBufferSequence,
                                           ConstBufferIterator,
                                           CompletionCondition,
                                           WriteHandler> &h,
  ...
  template <typename AsyncWriteStream,
            ...
            typename WriteHandler,
            typename Executor>
  struct associated_executor<detail::write_op<AsyncWriteStream,
                                              ConstBufferSequence,
                                              ConstBufferIterator,
                                              CompletionCondition,
                                              WriteHandler>,
  ...
  inline ASIO_INITFN_RESULT_TYPE(WriteHandler,
    ...
    detail::start_write_buffer_sequence_op(s,
                                           buffers,
                                           asio::buffer_sequence_begin(buffers),
                                           completion_condition,
  ...
  namespace detail {
    ...
    class write_dynbuf_op {
      ...
      write_dynbuf_op(write_dynbuf_op &&other)
          ...
          , completion_condition_(ASIO_MOVE_CAST(CompletionCondition)(
    ...
    asio_handler_allocate(std::size_t size,
                          write_dynbuf_op<AsyncWriteStream,
                                          DynamicBuffer,
                                          CompletionCondition,
                                          WriteHandler> *this_handler) {
      return asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
    ...
    template <typename AsyncWriteStream,
              ...
              typename WriteHandler>
    inline bool
    asio_handler_is_continuation(write_dynbuf_op<AsyncWriteStream,
                                                 DynamicBuffer,
                                                 CompletionCondition,
                                                 WriteHandler> *this_handler) {
  ...
  template <typename AsyncWriteStream,
            ...
            typename WriteHandler,
            typename Allocator>
  struct associated_allocator<detail::write_dynbuf_op<AsyncWriteStream,
                                                      DynamicBuffer,
                                                      CompletionCondition,
                                                      WriteHandler>,
                              Allocator> {
    ...
    static type get(const detail::write_dynbuf_op<AsyncWriteStream,
                                                  DynamicBuffer,
                                                  CompletionCondition,
                                                  WriteHandler> &h,
                    const Allocator &a = Allocator()) ASIO_NOEXCEPT {
  ...
  template <typename AsyncWriteStream,
            ...
            typename WriteHandler,
            typename Executor>
  struct associated_executor<detail::write_dynbuf_op<AsyncWriteStream,
                                                     DynamicBuffer,
                                                     CompletionCondition,
                                                     WriteHandler>,
                             Executor> {
  ...
  inline ASIO_INITFN_RESULT_TYPE(WriteHandler,
    ...
    detail::write_dynbuf_op<
        AsyncWriteStream,
        typename decay<DynamicBuffer>::type,
        CompletionCondition,
        ASIO_HANDLER_TYPE(WriteHandler, void(asio::error_code, std::size_t))>(
        s,
        ASIO_MOVE_CAST(DynamicBuffer)(buffers),
        completion_condition,
