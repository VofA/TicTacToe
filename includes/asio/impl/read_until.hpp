...
namespace asio {
  ...
  inline std::size_t read_until(SyncReadStream &s,
    ...
    std::size_t bytes_transferred =
        read_until(s, ASIO_MOVE_CAST(DynamicBuffer)(buffers), delim, ec);
  ...
  namespace detail {
    ...
    std::pair<Iterator1, bool> partial_search(Iterator1 first1,
                                              Iterator1 last1,
                                              Iterator2 first2,
                                              Iterator2 last2) {
  ...
  std::size_t read_until(SyncReadStream &s,
    ...
    for (;;) {
      ...
      std::pair<iterator, bool> result =
          detail::partial_search(start_pos, end, delim.begin(), delim.end());
      if (result.first != end) {
        if (result.second) {
  ...
  inline std::size_t read_until(SyncReadStream &s,
    ...
    asio::error_code ec;
    std::size_t bytes_transferred =
        read_until(s, ASIO_MOVE_CAST(DynamicBuffer)(buffers), expr, ec);
    asio::detail::throw_error(ec, "read_until");
    return bytes_transferred;
  }
  ...
  inline std::size_t read_until(
    ...
    asio::error_code ec;
    std::size_t bytes_transferred = read_until(
        s, ASIO_MOVE_CAST(DynamicBuffer)(buffers), match_condition, ec);
    asio::detail::throw_error(ec, "read_until");
    return bytes_transferred;
  }
  ...
  inline std::size_t read_until(
      ...
      typename enable_if<is_match_condition<MatchCondition>::value>::type *) {
    return read_until(
        s, basic_streambuf_ref<Allocator>(b), match_condition, ec);
  }
  ...
  namespace detail {
            ...
            for (;;) {
              {
                ...
                // Need to read some more data.
                  ...
                  bytes_to_read    = std::min<std::size_t>(
                      ...
                      std::min<std::size_t>(
                          65536, buffers_.max_size() - buffers_.size()));
                }
              }
              ...
              stream_.async_read_some(
                  buffers_.prepare(bytes_to_read),
    ...
    inline void *asio_handler_allocate(
        std::size_t size,
        read_until_delim_op<AsyncReadStream, DynamicBuffer, ReadHandler>
            *this_handler) {
  ...
  struct associated_allocator<
      detail::read_until_delim_op<AsyncReadStream, DynamicBuffer, ReadHandler>,
      Allocator> {
    typedef typename associated_allocator<ReadHandler, Allocator>::type type;

    static type get(const detail::read_until_delim_op<AsyncReadStream,
                                                      DynamicBuffer,
                                                      ReadHandler> &h,
  ...
  namespace detail {
            ...
            for (;;) {
              {
                ...
                // Need to read some more data.
                  ...
                  if (result.first != end) {
                    // Partial match. Next search needs to start from beginning
                    // of match.
    ...
    inline void *asio_handler_allocate(
        std::size_t size,
        read_until_delim_string_op<AsyncReadStream, DynamicBuffer, ReadHandler>
            *this_handler) {
      return asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
    }
  ...
  struct associated_allocator<
    ...
    static type get(const detail::read_until_delim_string_op<AsyncReadStream,
                                                             DynamicBuffer,
                                                             ReadHandler> &h,
                    const Allocator &a = Allocator()) ASIO_NOEXCEPT {
      return associated_allocator<ReadHandler, Allocator>::get(h.handler_, a);
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Executor>
  struct associated_executor<detail::read_until_delim_string_op<AsyncReadStream,
                                                                DynamicBuffer,
                                                                ReadHandler>,
                             Executor> {
    typedef typename associated_executor<ReadHandler, Executor>::type type;
  ...
  namespace detail {
            ...
            for (;;) {
              {
                ...
                boost::match_results<iterator,
                                     typename std::vector<boost::sub_match<
                                         iterator>>::allocator_type>
                    match_results;
                bool match =
                    regex_search(start_pos,
                                 end,
                                 match_results,
                                 expr_,
                                 boost::match_default | boost::match_partial);
    ...
    inline void *asio_handler_allocate(
        std::size_t size,
        read_until_expr_op<AsyncReadStream, DynamicBuffer, RegEx, ReadHandler>
            *this_handler) {
      return asio_handler_alloc_helpers::allocate(size, this_handler->handler_);
    }
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Allocator>
  struct associated_allocator<detail::read_until_expr_op<AsyncReadStream,
                                                         DynamicBuffer,
                                                         RegEx,
                                                         ReadHandler>,
                              Allocator> {
    ...
    static type get(const detail::read_until_expr_op<AsyncReadStream,
                                                     DynamicBuffer,
                                                     RegEx,
                                                     ReadHandler> &h,
                    const Allocator &a = Allocator()) ASIO_NOEXCEPT {
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Executor>
  struct associated_executor<detail::read_until_expr_op<AsyncReadStream,
                                                        DynamicBuffer,
                                                        RegEx,
                                                        ReadHandler>,
                             Executor> {
            ...
            for (;;) {
              {
                ...
                // Look for a match.
                std::pair<iterator, bool> result =
                    match_condition_(start_pos, end);
                if (result.second) {
                  // Full match. We're done.
                  search_position_ = result.first - begin;
                  bytes_to_read    = 0;
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Allocator>
  struct associated_allocator<detail::read_until_match_op<AsyncReadStream,
                                                          DynamicBuffer,
                                                          MatchCondition,
                                                          ReadHandler>,
                              Allocator> {
    ...
    static type get(const detail::read_until_match_op<AsyncReadStream,
                                                      DynamicBuffer,
                                                      MatchCondition,
                                                      ReadHandler> &h,
                    const Allocator &a = Allocator()) ASIO_NOEXCEPT {
  ...
  template <typename AsyncReadStream,
            ...
            typename ReadHandler,
            typename Executor>
  struct associated_executor<detail::read_until_match_op<AsyncReadStream,
                                                         DynamicBuffer,
                                                         MatchCondition,
                                                         ReadHandler>,
                             Executor> {
