...
namespace asio {
  ...
  inline thread_pool::executor_type thread_pool::get_executor() ASIO_NOEXCEPT {
  ...
  inline void
  thread_pool::executor_type::on_work_finished() const ASIO_NOEXCEPT {
  ...
  void thread_pool::executor_type::dispatch(ASIO_MOVE_ARG(Function) f,
    ...
    ASIO_HANDLER_CREATION(
        (pool_, *p.p, "thread_pool", &this->context(), 0, "dispatch"));
  ...
  void thread_pool::executor_type::post(ASIO_MOVE_ARG(Function) f,
    ...
    ASIO_HANDLER_CREATION(
        (pool_, *p.p, "thread_pool", &this->context(), 0, "post"));
  ...
  void thread_pool::executor_type::defer(ASIO_MOVE_ARG(Function) f,
    ...
    ASIO_HANDLER_CREATION(
        (pool_, *p.p, "thread_pool", &this->context(), 0, "defer"));
