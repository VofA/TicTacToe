...
namespace asio {
  ...
  namespace detail {
    ...
    std::size_t
    read_at_buffer_sequence(SyncRandomAccessReadDevice &d,
                            uint64_t offset,
  ...
  std::size_t read_at(SyncRandomAccessReadDevice &d,
                      ...
                      CompletionCondition completion_condition,
                      asio::error_code &ec) {
    return detail::read_at_buffer_sequence(d,
                                           offset,
                                           buffers,
  ...
  inline std::size_t read_at(SyncRandomAccessReadDevice &d,
    ...
    std::size_t bytes_transferred =
        read_at(d, offset, buffers, transfer_all(), ec);
  ...
  inline std::size_t read_at(SyncRandomAccessReadDevice &d,
    ...
    asio::error_code ec;
    std::size_t bytes_transferred =
        read_at(d, offset, buffers, completion_condition, ec);
    asio::detail::throw_error(ec, "read_at");
    return bytes_transferred;
  }
  ...
  inline std::size_t read_at(SyncRandomAccessReadDevice &d,
    ...
    asio::error_code ec;
    std::size_t bytes_transferred =
        read_at(d, offset, b, completion_condition, ec);
    asio::detail::throw_error(ec, "read_at");
    return bytes_transferred;
  }
  ...
  namespace detail {
    ...
    class read_at_op : detail::base_from_completion_cond<CompletionCondition> {
      public:
      ...
      void operator()(const asio::error_code &ec,
        ...
        switch (start_ = start) {
          case 1:
            ...
            do {
              device_.async_read_some_at(offset_ + buffers_.total_consumed(),
    ...
    template <typename AsyncRandomAccessReadDevice,
              ...
              typename ReadHandler>
    inline bool
    asio_handler_is_continuation(read_at_op<AsyncRandomAccessReadDevice,
                                            MutableBufferSequence,
                                            MutableBufferIterator,
                                            CompletionCondition,
                                            ReadHandler> *this_handler) {
    ...
    template <typename AsyncRandomAccessReadDevice,
              ...
              typename ReadHandler>
    inline void
    start_read_at_buffer_sequence_op(AsyncRandomAccessReadDevice &d,
                                     uint64_t offset,
                                     const MutableBufferSequence &buffers,
                                     const MutableBufferIterator &,
                                     CompletionCondition completion_condition,
  ...
  template <typename AsyncRandomAccessReadDevice,
            ...
            typename ReadHandler,
            typename Allocator>
  struct associated_allocator<detail::read_at_op<AsyncRandomAccessReadDevice,
                                                 MutableBufferSequence,
                                                 MutableBufferIterator,
                                                 CompletionCondition,
                                                 ReadHandler>,
    ...
    static type get(const detail::read_at_op<AsyncRandomAccessReadDevice,
                                             MutableBufferSequence,
                                             MutableBufferIterator,
                                             CompletionCondition,
                                             ReadHandler> &h,
  ...
  template <typename AsyncRandomAccessReadDevice,
            ...
            typename ReadHandler,
            typename Executor>
  struct associated_executor<detail::read_at_op<AsyncRandomAccessReadDevice,
                                                MutableBufferSequence,
                                                MutableBufferIterator,
                                                CompletionCondition,
                                                ReadHandler>,
  ...
  inline ASIO_INITFN_RESULT_TYPE(ReadHandler,
    ...
    detail::start_read_at_buffer_sequence_op(
        d,
        offset,
        buffers,
        asio::buffer_sequence_begin(buffers),
