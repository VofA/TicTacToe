...
namespace asio {
  ...
  class async_result<basic_yield_context<Handler>, ReturnType(Arg1)>
    ...
    public:
    explicit async_result(
        typename detail::coro_async_result<
            Handler,
  ...
  template <typename Handler, typename ReturnType>
  class async_result<basic_yield_context<Handler>, ReturnType(asio::error_code)>
      : public detail::coro_async_result<Handler, void> {
    public:
    explicit async_result(
        typename detail::coro_async_result<Handler,
  ...
  class async_result<detail::coro_handler<Handler, T>>
    ...
    explicit async_result(
        typename detail::coro_async_result<Handler, T>::completion_handler_type
            &h)
  ...
  namespace detail {
    ...
    asio_handler_invoke(Function &function,
      ...
      asio_handler_invoke_helpers::invoke(function,
                                          this_handler->data_->handler_);
    }
  ...
  template <typename Handler, typename Function>
  void
  spawn(ASIO_MOVE_ARG(Handler) handler,
    ...
    helper.data_.reset(new detail::spawn_data<handler_type, function_type>(
  ...
  void spawn(basic_yield_context<Handler> ctx,
    ...
    helper.data_.reset(new detail::spawn_data<Handler, function_type>(
        ASIO_MOVE_CAST(Handler)(handler),
        false,
        ASIO_MOVE_CAST(Function)(function)));
    helper.attributes_ = attributes;
  ...
  inline void spawn(const strand<Executor> &ex,
                    ASIO_MOVE_ARG(Function) function,
                    const boost::coroutines::attributes &attributes) {
    asio::spawn(asio::bind_executor(ex, &detail::default_spawn_handler),
                ASIO_MOVE_CAST(Function)(function),
                attributes);
  }
  ...
  inline void spawn(const asio::io_context::strand &s,
                    ASIO_MOVE_ARG(Function) function,
                    const boost::coroutines::attributes &attributes) {
    asio::spawn(asio::bind_executor(s, &detail::default_spawn_handler),
                ASIO_MOVE_CAST(Function)(function),
                attributes);
  }
  ...
  inline void spawn(
    ...
    asio::spawn(
        ctx.get_executor(), ASIO_MOVE_CAST(Function)(function), attributes);
  }
