    ...
    namespace detail {
      namespace socket_option {
        ...
        class multicast_enable_loopback {
          ...
          // Default constructor.
          multicast_enable_loopback() : ipv4_value_(0), ipv6_value_(0) {
          }

          // Construct with a specific option value.
          explicit multicast_enable_loopback(bool v)
              : ipv4_value_(v ? 1 : 0), ipv6_value_(v ? 1 : 0) {
          }
        ...
        class unicast_hops {
          public:
          // Default constructor.
          unicast_hops() : value_(0) {
          }

          // Construct with a specific option value.
          explicit unicast_hops(int v) : value_(v) {
          }
        ...
        class multicast_hops {
          ...
          // Default constructor.
          multicast_hops() : ipv4_value_(0), ipv6_value_(0) {
          }
        ...
        class multicast_request {
          ...
          // Construct with multicast address and IPv4 address specifying an
          // interface.
          explicit multicast_request(
              const address_v4 &multicast_address,
        ...
        // Helper template for implementing options that specify a network
        // interface.
        template <int IPv4_Level, int IPv4_Name, int IPv6_Level, int IPv6_Name>
        class network_interface {
          ...
          // Default constructor.
          network_interface() {
            ipv4_value_.s_addr = asio::detail::socket_ops::host_to_network_long(
                address_v4::any().to_uint());
            ipv6_value_ = 0;
          }
