...
namespace asio {
  namespace ip {
    ...
    class network_v6 {
      public:
      /// Default constructor.
      network_v6() ASIO_NOEXCEPT : address_(), prefix_length_(0) {
      }
     ...
     * @relates address_v6
     */
    inline network_v6 make_network_v6(const address_v6 &addr,
    ...
    operator<<(std::basic_ostream<Elem, Traits> &os, const network_v6 &net);
