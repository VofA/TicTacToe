...
namespace asio {
  namespace ip {
    ...
    class address_v4 {
      ...
      /// (Deprecated: Use make_address_v4().) Create an address from an IP
      /// address string in dotted decimal form.
      ...
      /// (Deprecated: Use network_v4 class.) Obtain the netmask that
      /// corresponds to the address, based on its address class.
     ...
     * @relates address_v4
     */
    ASIO_DECL address_v4 make_address_v4(string_view str, asio::error_code &ec);
