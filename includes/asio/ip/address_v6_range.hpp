...
namespace asio {
  namespace ip {
    ...
    class basic_address_range<address_v6> {
      ...
      basic_address_range() ASIO_NOEXCEPT : begin_(address_v6()),
                                            end_(address_v6()) {
      }
      ...
      /// Assignment operator.
      basic_address_range &
      operator=(const basic_address_range &other) ASIO_NOEXCEPT {
        begin_ = other.begin_;
        end_   = other.end_;
        return *this;
      }
      ...
      basic_address_range &
      operator=(basic_address_range &&other) ASIO_NOEXCEPT {
        begin_ = ASIO_MOVE_CAST(iterator)(other.begin_);
        end_   = ASIO_MOVE_CAST(iterator)(other.end_);
        return *this;
      }
