...
namespace asio {
  namespace ip {
     ...
     *
     * The iterator's value_type, obtained when a results iterator is
     * dereferenced, is: @code const basic_resolver_entry<InternetProtocol>
     * @endcode
     *
...
#endif // !defined(ASIO_NO_DEPRECATED)
    {
      ...
      static basic_resolver_results create(EndpointIterator begin,
