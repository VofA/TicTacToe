...
namespace asio {
  namespace ip {
     ...
     * @relates address_v6
     */
    ASIO_DECL address_v6 make_address_v6(string_view str, asio::error_code &ec);
     ...
     * @relates address_v4
     */
    ASIO_DECL address_v4 make_address_v4(v4_mapped_t,
     ...
     * @relates address_v6
     */
    ASIO_DECL address_v6 make_address_v6(v4_mapped_t,
