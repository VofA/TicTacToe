...
namespace asio {
  ...
  /// The serial_port_base class is used as a base for the basic_serial_port
  /// class template so that we have a common place to define the serial port
  /// options.
  class serial_port_base {
    ...
    class baud_rate {
      ...
      ASIO_DECL ASIO_SYNC_OP_VOID store(ASIO_OPTION_STORAGE &storage,
                                        asio::error_code &ec) const;
      ASIO_DECL ASIO_SYNC_OP_VOID load(const ASIO_OPTION_STORAGE &storage,
                                       asio::error_code &ec);
