...
namespace asio {
   ...
   *
   * Specialisations shall meet the following requirements, where @c t is a
   * const reference to an object of type @c T, and @c e is an object of type @c
   * Executor.
   *
  ...
  inline typename associated_executor<
      T,
  ...
  get_associated_executor(
      ...
      typename enable_if<
          ...
          * = 0) ASIO_NOEXCEPT {
    return associated_executor<T, typename ExecutionContext::executor_type>::
        get(t, ctx.get_executor());
  }
