...
namespace asio {
  ...
  class basic_stream_socket : public basic_socket<Protocol ASIO_SVC_TARG> {
    public:
     ...
     * or received on it.
     *
     * @param io_context The io_context object that the stream socket will use
    ...
    /**
     * This constructor creates and opens a stream socket. The socket needs to
    ...
    /**
     * This constructor creates a stream socket object to hold an existing
     * native socket.
     *
     * @param io_context The io_context object that the stream socket will use
     * to dispatch handlers for any asynchronous operations performed on the
     ...
     * if constructed using the @c basic_stream_socket(io_context&) constructor.
     */
    ...
    /**
     * This assignment operator moves a stream socket from one object to
     * another.
     *
     * @param other The other basic_stream_socket object from which the move
     * will occur.
    ...
    typename enable_if<is_convertible<Protocol1, Protocol>::value,
                       basic_stream_socket>::type &
    operator=(basic_stream_socket<Protocol1 ASIO_SVC_TARG1> &&other) {
      basic_socket<Protocol ASIO_SVC_TARG>::operator=(std::move(other));
      return *this;
    }
     ...
     *
     * @note The receive operation may not receive all of the requested number
     * of bytes. Consider using the @ref async_read function if you need to
     ...
     *
     * @par Example
     * To read into a single data buffer use the @ref buffer function as
     * follows:
     * @code
     * socket.read_some(asio::buffer(data, size));
     * @endcode
     * See the @ref buffer documentation for information on reading into
     * multiple buffers in one go, and how to use it with arrays, boost::array
     * or std::vector.
     */
    template <typename MutableBufferSequence>
