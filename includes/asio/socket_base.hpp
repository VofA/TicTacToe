...
namespace asio {
  ...
  class socket_base {
    ...
    /**
     * Implements a custom socket option that determines whether or not an
     * accept operation is permitted to fail with
     * asio::error::connection_aborted. By default the option is false.
     *
     * @par Examples
     * Setting the option:
     * @code
    ...
    /// (Deprecated: Use max_listen_connections.) The maximum length of the
    /// queue of pending incoming connections.
#if defined(GENERATING_DOCUMENTATION)
