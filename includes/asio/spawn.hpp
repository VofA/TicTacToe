...
namespace asio {
  ...
  typedef basic_yield_context<executor_binder<void (*)(), executor>>
      yield_context;
#endif // defined(GENERATING_DOCUMENTATION)
   ...
   *
   * @param function The coroutine function. The function must have the
   * signature:
   * @code void function(basic_yield_context<Handler> yield); @endcode
   *
   * @param attributes Boost.Coroutine attributes used to customise the
   * coroutine.
   */
  ...
  /// Start a new stackful coroutine, inheriting the execution context of
  /// another.
  /**
   * This function is used to launch a new coroutine.
   *
   ...
   * executing in a particular strand, then the new coroutine will execute in
   * the same strand.
   *
   * @param function The coroutine function. The function must have the
   * signature:
   ...
   * strand, the implementation ensures that none of those coroutines can
   ...
   * This function is used to launch a new coroutine.
   *
   * @param ctx Identifies the execution context that will run the coroutine.
   * The new coroutine is implicitly given its own strand within this execution
   * context.
   *
   * @param function The coroutine function. The function must have the
   * signature:
