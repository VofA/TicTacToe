...
namespace asio {
   ...
   *
   * @li Obtains the handler's associated allocator object @c alloc by
   * performing <tt>get_associated_allocator(handler)</tt>.
   *
  ...
  dispatch(ASIO_MOVE_ARG(CompletionToken) token);
