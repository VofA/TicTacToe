...
#define ASIO_PRIVATE_CTR_DEF(n)                                              \
  ...
  explicit basic_socket_iostream(ASIO_VARIADIC_BYVAL_PARAMS(n))              \
      : std::basic_iostream<char>(&this->detail::socket_iostream_base<       \
...
/// Iostream interface for a socket.
  ...
  class basic_socket_iostream
      : private detail::socket_iostream_base<Protocol ASIO_SVC_TARG,
                                             Clock,
                                             WaitTraits ASIO_SVC_TARG1>,
    ...
    explicit basic_socket_iostream(basic_stream_socket<protocol_type> s)
        : detail::socket_iostream_base<Protocol ASIO_SVC_TARG,
                                       Clock,
...
#if defined(ASIO_HAS_STD_IOSTREAM_MOVE) || defined(GENERATING_DOCUMENTATION)
...
#if !defined(ASIO_NO_DEPRECATED)
    /// (Deprecated: Use expiry().) Get the stream's expiry time relative to
    /// now.
    /**
    ...
    basic_socket_iostream &
    operator=(const basic_socket_iostream &) ASIO_DELETED;
  };
