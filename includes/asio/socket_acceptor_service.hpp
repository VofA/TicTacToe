...
namespace asio {
...
#endif
  {
    ...
    void converting_move_construct(
        ...
        typename socket_acceptor_service<Protocol1>::implementation_type
            &other_impl,
    ...
    /// connections.
    ASIO_SYNC_OP_VOID
    listen(implementation_type &impl, int backlog, asio::error_code &ec) {
    ...
    async_accept(
      ...
      service_impl_.async_accept(
          impl, peer, peer_endpoint, init.completion_handler);
    ...
    async_accept(implementation_type &impl,
      ...
      service_impl_.async_accept(
          impl, peer_io_context, peer_endpoint, init.completion_handler);
