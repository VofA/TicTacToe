...
namespace asio {
  namespace posix {
    ...
    /**
     * The posix::basic_stream_descriptor class template provides asynchronous
     * and blocking stream-oriented descriptor functionality.
     *
     * @par Thread Safety
    ...
    class basic_stream_descriptor
       ...
       * descriptor needs to be opened and then connected or accepted before
       ...
       *
       * @param other The other basic_stream_descriptor object from which the
       * move will occur.
       *
       * @note Following the move, the moved-from object is in the same state as
       * if constructed using the @c basic_stream_descriptor(io_context&)
       * constructor.
       */
      ...
      /**
       * This function is used to write data to the stream descriptor. The
       * function call will block until one or more bytes of the data has been
       * written successfully, or until an error occurs.
       *
       * @param buffers One or more data buffers to be written to the
       * descriptor.
       *
       ...
       *
       * @param buffers One or more data buffers to be written to the
       * descriptor. Although the buffers object may be copied as necessary,
