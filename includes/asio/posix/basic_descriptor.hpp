...
namespace asio {
  namespace posix {
    ...
    class basic_descriptor : public basic_io_object<DescriptorService>,
       ...
       * if constructed using the @c basic_descriptor(io_context&) constructor.
       */
       ...
       * of layers. Since a basic_descriptor cannot contain any further layers,
