...
namespace asio {
  ...
  class basic_raw_socket : public basic_socket<Protocol ASIO_SVC_TARG> {
    public:
     ...
     * if constructed using the @c basic_raw_socket(io_context&) constructor.
     */
    ...
    typename enable_if<is_convertible<Protocol1, Protocol>::value,
                       basic_raw_socket>::type &
    operator=(basic_raw_socket<Protocol1 ASIO_SVC_TARG1> &&other) {
      basic_socket<Protocol ASIO_SVC_TARG>::operator=(std::move(other));
      return *this;
    }
     ...
     * is retained by the caller, which must guarantee that it is valid until
