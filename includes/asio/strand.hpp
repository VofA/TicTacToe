...
namespace asio {
  ...
  class strand {
    ...
    strand()
        : executor_()
        , impl_(
              use_service<detail::strand_executor_service>(executor_.context())
    ...
    /**
     * This constructor is only valid if the @c OtherExecutor type is
    ...
    void dispatch(ASIO_MOVE_ARG(Function) f, const Allocator &a) const {
      detail::strand_executor_service::dispatch(
          impl_, executor_, ASIO_MOVE_CAST(Function)(f), a);
    }
     ...
     * Instead, it will be scheduled by the underlying executor's defer
     * function.
     *
     * @param f The function object to be called. The executor will make
     * a copy of the handler object as required. The function signature of the
    ...
    void post(ASIO_MOVE_ARG(Function) f, const Allocator &a) const {
      detail::strand_executor_service::post(
          impl_, executor_, ASIO_MOVE_CAST(Function)(f), a);
    }
    ...
    void defer(ASIO_MOVE_ARG(Function) f, const Allocator &a) const {
      detail::strand_executor_service::defer(
          impl_, executor_, ASIO_MOVE_CAST(Function)(f), a);
    }
