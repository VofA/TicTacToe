  ...
  namespace ssl {
    namespace detail {
      ...
      class openssl_init_base : private noncopyable {
        ...
        // Helper function to manage a do_init singleton. The static instance of
        // the openssl_init object ensures that this function is always called
        // before main, and therefore before any other threads can get started.
        // The do_init instance must be static in this function to ensure that
        // it gets initialised before any other global objects try to use it.
      ...
      class openssl_init : private openssl_init_base {
       ...
       // && (OPENSSL_VERSION_NUMBER >= 0x00908000L)
        ...
        // Reference to singleton do_init object to ensure that openssl does not
        // get cleaned up until the last user has finished with it.
