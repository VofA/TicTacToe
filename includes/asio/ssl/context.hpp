...
namespace asio {
  namespace ssl {
    ...
    class context : public context_base, private noncopyable {
       ...
       *
       * @note Following the move, the following operations only are valid for
      ...
      /**
       * This assignment operator moves an SSL context from one object to
       * another.
       *
       * @param other The other context object from which the move will occur.
       *
      ...
      /**
       * This function may be used to obtain the underlying implementation of
       * the context. This is intended to allow access to context functionality
      ...
      /**
       * This function may be used to configure the SSL options used by the
       * context.
       *
       * @param o A bitmask of options. The available option values are defined
       * in the context_base class. The specified options, if currently enabled
       * on the context, are cleared.
       *
       ...
       *
       * @param o A bitmask of options. The available option values are defined
       * in the context_base class. The options are bitwise-ored with any
       * existing value for the options.
       *
       * @throws asio::system_error Thrown on failure.
       *
       ...
       * @note Calls @c SSL_CTX_set_verify.
       */
      ASIO_DECL ASIO_SYNC_OP_VOID set_verify_mode(verify_mode v,
                                                  asio::error_code &ec);
       ...
       * @note Calls @c SSL_CTX_set_verify_depth.
       */
      ASIO_DECL ASIO_SYNC_OP_VOID set_verify_depth(int depth,
                                                   asio::error_code &ec);

      /// Set the callback used to verify peer certificates.
      /**
       * This function is used to specify a callback function that will be
       * called by the implementation when it needs to verify a peer
       * certificate.
       *
       * @param callback The function object to be used for verifying a
       * certificate. The function signature of the handler must be:
      ...
      /**
       * This function is used to load one or more trusted certification
       * authorities from a file.
       *
       ...
       * @note Calls @c SSL_CTX_load_verify_locations.
       */
      ASIO_DECL ASIO_SYNC_OP_VOID load_verify_file(const std::string &filename,
                                                   asio::error_code &ec);
       ...
       *
       * @param ca The buffer containing the certification authority
       * certificate. The certificate must use the PEM format.
       *
       * @throws asio::system_error Thrown on failure.
       *
       ...
       * @note Calls @c SSL_CTX_get_cert_store and @c X509_STORE_add_cert.
       */
      ASIO_DECL ASIO_SYNC_OP_VOID
      add_certificate_authority(const const_buffer &ca, asio::error_code &ec);
       ...
       */
      ASIO_DECL ASIO_SYNC_OP_VOID
      set_default_verify_paths(asio::error_code &ec);
       ...
       * @note Calls @c SSL_CTX_load_verify_locations.
       */
      ASIO_DECL ASIO_SYNC_OP_VOID add_verify_path(const std::string &path,
                                                  asio::error_code &ec);
       ...
       */
      ASIO_DECL void use_certificate(const const_buffer &certificate,
                                     file_format format);
       ...
       */
      ASIO_DECL void use_certificate_file(const std::string &filename,
                                          file_format format);
       ...
       */
      ASIO_DECL ASIO_SYNC_OP_VOID
      use_certificate_file(const std::string &filename,
                           file_format format,
                           asio::error_code &ec);
       ...
       * a buffer.
       *
       * @param chain The buffer containing the certificate chain. The
       * certificate chain must use the PEM format.
       *
       * @throws asio::system_error Thrown on failure.
       *
       * @note Calls @c SSL_CTX_use_certificate and
       ...
       */
      ASIO_DECL ASIO_SYNC_OP_VOID
      use_certificate_chain(const const_buffer &chain, asio::error_code &ec);
       ...
       * a file.
       *
       * @param filename The name of the file containing the certificate. The
       ...
       */
      ASIO_DECL void use_private_key(const const_buffer &private_key,
                                     file_format format);
       ...
       */
      ASIO_DECL void use_private_key_file(const std::string &filename,
                                          file_format format);
       ...
       */
      ASIO_DECL ASIO_SYNC_OP_VOID
      use_private_key_file(const std::string &filename,
                           file_format format,
                           asio::error_code &ec);
       ...
       * @throws asio::system_error Thrown on failure.
       *
       * @note Calls @c SSL_CTX_use_RSAPrivateKey or
       * SSL_CTX_use_RSAPrivateKey_ASN1.
       */
      ASIO_DECL void use_rsa_private_key(const const_buffer &private_key,
                                         file_format format);
       ...
       */
      ASIO_DECL void use_rsa_private_key_file(const std::string &filename,
                                              file_format format);
       ...
       */
      ASIO_DECL ASIO_SYNC_OP_VOID
      use_rsa_private_key_file(const std::string &filename,
                               file_format format,
                               asio::error_code &ec);
      ...
      /// parameters.
      /**
       * This function is used to load Diffie-Hellman parameters into the
       * context from a buffer.
       *
       * @param dh The memory buffer containing the Diffie-Hellman parameters.
       ...
       * @note Calls @c SSL_CTX_set_tmp_dh.
       */
      ASIO_DECL ASIO_SYNC_OP_VOID use_tmp_dh(const const_buffer &dh,
                                             asio::error_code &ec);

      /// Use the specified file to obtain the temporary Diffie-Hellman
      /// parameters.
      /**
       * This function is used to load Diffie-Hellman parameters into the
       * context from a file.
       ...
       * @note Calls @c SSL_CTX_set_tmp_dh.
       */
      ASIO_DECL ASIO_SYNC_OP_VOID use_tmp_dh_file(const std::string &filename,
                                                  asio::error_code &ec);
       ...
       *
       * @param callback The function object to be used for obtaining the
       * password. The function signature of the handler must be:
       * @code std::string password_callback(
       *   std::size_t max_length,  // The maximum size for a password.
       *   password_purpose purpose // Whether password is for reading or
       * writing.
       * ); @endcode
      ...
      // Callback used when the SSL implementation wants to verify a
      // certificate.
      ASIO_DECL static int verify_callback_function(int preverified,
                                                    X509_STORE_CTX *ctx);
      ...
      ASIO_DECL static int
      password_callback_function(char *buf, int size, int purpose, void *data);

      // Helper function to set the temporary Diffie-Hellman parameters from a
      // BIO.
