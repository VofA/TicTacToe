...
#if !defined(GENERATING_DOCUMENTATION)
      // The following types and constants are preserved for backward
      // compatibility. New programs should use the equivalents of the same
      // names that are defined in the asio::ssl namespace.
