...
#define ASIO_VARIADIC_TPARAMS_1 typename T1
#define ASIO_VARIADIC_TPARAMS_2 typename T1, typename T2
#define ASIO_VARIADIC_TPARAMS_3 typename T1, typename T2, typename T3
...
#define ASIO_VARIADIC_BYVAL_PARAMS(n) ASIO_VARIADIC_BYVAL_PARAMS_##n
...
#define ASIO_VARIADIC_BYVAL_ARGS(n) ASIO_VARIADIC_BYVAL_ARGS_##n
...
#define ASIO_VARIADIC_MOVE_PARAMS(n) ASIO_VARIADIC_MOVE_PARAMS_##n

#define ASIO_VARIADIC_MOVE_PARAMS_1 ASIO_MOVE_ARG(T1) x1
#define ASIO_VARIADIC_MOVE_PARAMS_2 ASIO_MOVE_ARG(T1) x1, ASIO_MOVE_ARG(T2) x2
#define ASIO_VARIADIC_MOVE_PARAMS_3 \
  ASIO_MOVE_ARG(T1) x1, ASIO_MOVE_ARG(T2) x2, ASIO_MOVE_ARG(T3) x3
#define ASIO_VARIADIC_MOVE_PARAMS_4 \
  ASIO_MOVE_ARG(T1)                 \
  x1, ASIO_MOVE_ARG(T2) x2, ASIO_MOVE_ARG(T3) x3, ASIO_MOVE_ARG(T4) x4
#define ASIO_VARIADIC_MOVE_PARAMS_5                                     \
  ASIO_MOVE_ARG(T1)                                                     \
  x1, ASIO_MOVE_ARG(T2) x2, ASIO_MOVE_ARG(T3) x3, ASIO_MOVE_ARG(T4) x4, \
      ASIO_MOVE_ARG(T5) x5

#define ASIO_VARIADIC_MOVE_ARGS(n) ASIO_VARIADIC_MOVE_ARGS_##n

#define ASIO_VARIADIC_MOVE_ARGS_1 ASIO_MOVE_CAST(T1)(x1)
#define ASIO_VARIADIC_MOVE_ARGS_2 ASIO_MOVE_CAST(T1)(x1), ASIO_MOVE_CAST(T2)(x2)
#define ASIO_VARIADIC_MOVE_ARGS_3 \
  ASIO_MOVE_CAST(T1)(x1), ASIO_MOVE_CAST(T2)(x2), ASIO_MOVE_CAST(T3)(x3)
#define ASIO_VARIADIC_MOVE_ARGS_4 \
  ASIO_MOVE_CAST(T1)              \
  (x1), ASIO_MOVE_CAST(T2)(x2), ASIO_MOVE_CAST(T3)(x3), ASIO_MOVE_CAST(T4)(x4)
#define ASIO_VARIADIC_MOVE_ARGS_5                       \
  ASIO_MOVE_CAST(T1)                                    \
  (x1), ASIO_MOVE_CAST(T2)(x2), ASIO_MOVE_CAST(T3)(x3), \
      ASIO_MOVE_CAST(T4)(x4), ASIO_MOVE_CAST(T5)(x5)

#define ASIO_VARIADIC_DECAY(n) ASIO_VARIADIC_DECAY_##n

#define ASIO_VARIADIC_DECAY_1 typename decay<T1>::type
#define ASIO_VARIADIC_DECAY_2 typename decay<T1>::type, typename decay<T2>::type
#define ASIO_VARIADIC_DECAY_3 \
  typename decay<T1>::type, typename decay<T2>::type, typename decay<T3>::type
