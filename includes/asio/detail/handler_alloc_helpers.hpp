  ...
  struct ptr {                                                             \
    ...
    static op *allocate(Handler &handler) {                                \
      ...
      typedef typename ::asio::detail::get_hook_allocator<                 \
          Handler,                                                         \
          associated_allocator_type>::type hook_allocator_type;            \
      ASIO_REBIND_ALLOC(hook_allocator_type, op)                           \
      a(::asio::detail::                                                   \
            get_hook_allocator<Handler, associated_allocator_type>::get(   \
...
#define ASIO_DEFINE_HANDLER_ALLOCATOR_PTR(op)                                 \
  struct ptr {                                                                \
    ...
    static op *allocate(const Alloc &a) {                                     \
      typedef typename ::asio::detail::get_recycling_allocator<Alloc>::type   \
          recycling_allocator_type;                                           \
      ASIO_REBIND_ALLOC(recycling_allocator_type, op)                         \
      a1(::asio::detail::get_recycling_allocator<Alloc>::get(a));             \
