...
namespace asio {
  namespace detail {
    ...
    class hash_map : private noncopyable {
      ...
      // Constructor.
      hash_map() : size_(0), buckets_(0), num_buckets_(0) {
      }
      ...
      // Insert an element into the values list by splicing from the spares
      // list, if a spare is available, and otherwise by inserting a new
      // element.
      ...
      // Erase an element from the values list by splicing it to the spares
      // list.
      ...
      // only are stored in the hash map.
