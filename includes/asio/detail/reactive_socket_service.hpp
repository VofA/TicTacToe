  ...
  namespace detail {
    ...
    class reactive_socket_service
      ...
      void converting_move_construct(
          ...
          typename reactive_socket_service<Protocol1>::implementation_type
              &other_impl) {
        this->base_move_construct(impl, other_impl);
      ...
      asio::error_code set_option(implementation_type &impl,
        ...
        socket_ops::setsockopt(impl.socket_,
                               impl.state_,
                               option.level(impl.protocol_),
                               option.name(impl.protocol_),
                               option.data(impl.protocol_),
                               option.size(impl.protocol_),
                               ec);
        return ec;
      }
      ...
      endpoint_type local_endpoint(const implementation_type &impl,
        ...
        if (socket_ops::getsockname(
                impl.socket_, endpoint.data(), &addr_len, ec))
      ...
      endpoint_type remote_endpoint(const implementation_type &impl,
        ...
        endpoint_type endpoint;
        std::size_t addr_len = endpoint.capacity();
        if (socket_ops::getpeername(
                impl.socket_, endpoint.data(), &addr_len, false, ec))
          return endpoint_type();
        endpoint.resize(addr_len);
        return endpoint;
      }
      ...
      // Receive a datagram with the endpoint of the sender. Returns the number
      // of bytes received.
      ...
      size_t receive_from(implementation_type &impl,
        ...
        std::size_t bytes_recvd =
            socket_ops::sync_recvfrom(impl.socket_,
                                      impl.state_,
                                      bufs.buffers(),
                                      bufs.count(),
                                      flags,
      ...
      // and the sender_endpoint object must both be valid for the lifetime of
      ...
      void async_receive_from(implementation_type &impl,
        ...
        p.p          = new (p.v) op(
            impl.socket_, protocol, buffers, sender_endpoint, flags, handler);
      ...
      asio::error_code accept(implementation_type &impl,
        ...
        socket_holder new_socket(
            socket_ops::sync_accept(impl.socket_,
                                    impl.state_,
                                    peer_endpoint ? peer_endpoint->data() : 0,
                                    peer_endpoint ? &addr_len : 0,
                                    ec));
      ...
      typename Protocol::socket accept(implementation_type &impl,
                                       ...
                                       endpoint_type *peer_endpoint,
                                       asio::error_code &ec) {
        typename Protocol::socket peer(peer_io_context ? *peer_io_context
                                                       : io_context_);
      ...
      // Start an asynchronous accept. The peer and peer_endpoint objects must
      // be valid until the accept's handler is invoked.
...
#if defined(ASIO_HAS_MOVE)
      // Start an asynchronous accept. The peer_endpoint object must be valid
      // until the accept's handler is invoked.
      template <typename Handler>
      void async_accept(implementation_type &impl,
      ...
      asio::error_code connect(implementation_type &impl,
                               ...
                               asio::error_code &ec) {
        socket_ops::sync_connect(
            impl.socket_, peer_endpoint.data(), peer_endpoint.size(), ec);
        return ec;
      }
