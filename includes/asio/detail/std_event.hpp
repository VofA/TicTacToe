...
namespace asio {
  namespace detail {
    ...
    class std_event : private noncopyable {
      ...
      private:
      // Helper class to temporarily adapt a scoped_lock into a unique_lock so
      // that it can be passed to std::condition_variable::wait().
      ...
      // Helper to increment and decrement the state to track outstanding
      // waiters.
      class waiter {
        public:
