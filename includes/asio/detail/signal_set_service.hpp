...
namespace asio {
  namespace detail {
    ...
    class signal_set_service : public service_base<signal_set_service> {
      public:
      ...
      class implementation_type {
        public:
        // Default constructor.
        implementation_type() : signals_(0) {
        }
      ...
      ASIO_DECL void notify_fork(asio::io_context::fork_event fork_ev);
      ...
      void async_wait(implementation_type &impl, Handler &handler) {
        ...
        ASIO_HANDLER_CREATION((
            io_context_.context(), *p.p, "signal_set", &impl, 0, "async_wait"));
