  ...
  namespace detail {
    ...
    class wrapped_handler {
      ...
      wrapped_handler(const wrapped_handler &other)
          : dispatcher_(other.dispatcher_), handler_(other.handler_) {
      }
    ...
    class rewrapped_handler {
      ...
      explicit rewrapped_handler(Handler &handler, const Context &context)
          : context_(context), handler_(ASIO_MOVE_CAST(Handler)(handler)) {
      }
      ...
      rewrapped_handler(const rewrapped_handler &other)
          : context_(other.context_), handler_(other.handler_) {
      }
    ...
    inline bool asio_handler_is_continuation(
        wrapped_handler<Dispatcher, Handler, IsContinuation> *this_handler) {
      return IsContinuation()(this_handler->dispatcher_,
    ...
    inline void asio_handler_invoke(
        Function &function,
        wrapped_handler<Dispatcher, Handler, IsContinuation> *this_handler) {
      this_handler->dispatcher_.dispatch(rewrapped_handler<Function, Handler>(
    ...
    asio_handler_allocate(std::size_t size,
      ...
      return asio_handler_alloc_helpers::allocate(size, this_handler->context_);
    }
    ...
    asio_handler_invoke(Function &function,
                        rewrapped_handler<Handler, Context> *this_handler) {
      asio_handler_invoke_helpers::invoke(function, this_handler->context_);
    }
