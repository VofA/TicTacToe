...
// for threads support.
    ...
    defined(_POSIX_SOURCE) || (defined(__MACH__) && defined(__APPLE__)) || \
...
#if defined(ASIO_HAS_IOCP) || !defined(ASIO_WINDOWS) &&             \
...
#elif defined(__GNUC__) && !defined(__MINGW32__) && !defined(linux) && \
