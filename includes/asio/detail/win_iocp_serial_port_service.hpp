...
namespace asio {
  namespace detail {
    ...
    class win_iocp_serial_port_service
      ...
      // Constructor.
      ASIO_DECL win_iocp_serial_port_service(asio::io_context &io_context);
      ...
      void move_assign(implementation_type &impl,
                       ...
                       implementation_type &other_impl) {
        handle_service_.move_assign(
            impl, other_service.handle_service_, other_impl);
      }
      ...
      asio::error_code set_option(implementation_type &impl,
        ...
        return do_set_option(impl,
                             &win_iocp_serial_port_service::store_option<
      ...
      asio::error_code get_option(const implementation_type &impl,
        ...
        return do_get_option(impl,
                             &win_iocp_serial_port_service::load_option<
      ...
      store_option(const void *option, ::DCB &storage, asio::error_code &ec) {
      ...
      template <typename GettableSerialPortOption>
      static asio::error_code
      load_option(void *option, const ::DCB &storage, asio::error_code &ec) {
