  ...
  namespace detail {
    ...
    class reactive_socket_recvfrom_op_base : public reactor_op {
      ...
      reactive_socket_recvfrom_op_base(socket_type socket,
          ...
          : reactor_op(&reactive_socket_recvfrom_op_base::do_perform,
                       complete_func)
          , socket_(socket)
      ...
      static status do_perform(reactor_op *base) {
        ...
        status result =
            socket_ops::non_blocking_recvfrom(o->socket_,
                                              bufs.buffers(),
                                              bufs.count(),
                                              o->flags_,
        ...
        ASIO_HANDLER_REACTOR_OPERATION(
            (*o, "non_blocking_recvfrom", o->ec_, o->bytes_transferred_));
    ...
    class reactive_socket_recvfrom_op
        : public reactive_socket_recvfrom_op_base<MutableBufferSequence,
                                                  Endpoint> {
      public:
      ...
      static void do_complete(void *owner,
        ...
        // associated with the handler. Consequently, a local copy of the
        // handler is required to ensure that any owning sub-object remains
        // valid until after we have deallocated the memory here.
        detail::binder2<Handler, asio::error_code, std::size_t> handler(
