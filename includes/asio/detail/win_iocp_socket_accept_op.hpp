  ...
  namespace detail {
    ...
    class win_iocp_socket_accept_op : public operation {
      ...
      static void do_complete(void *owner,
        ...
        win_iocp_socket_accept_op *o(
            static_cast<win_iocp_socket_accept_op *>(base));
          ...
          if (!ec) {
            o->peer_.assign(o->protocol_,
                            typename Socket::native_handle_type(
                                o->new_socket_.get(), peer_endpoint),
                            ec);
            if (!ec)
    ...
    class win_iocp_socket_move_accept_op : public operation {
      ...
      win_iocp_socket_move_accept_op(
          win_iocp_socket_service_base &socket_service,
          socket_type socket,
          const Protocol &protocol,
      ...
      static void do_complete(void *owner,
        ...
        // valid until after we have deallocated the memory here.
        detail::
            move_binder2<Handler, asio::error_code, typename Protocol::socket>
                handler(0,
                        ASIO_MOVE_CAST(Handler)(o->handler_),
                        ec,
