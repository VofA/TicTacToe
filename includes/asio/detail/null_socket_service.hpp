...
namespace asio {
  namespace detail {
    ...
    class null_socket_service
      ...
      asio::error_code
      open(implementation_type &, const protocol_type &, asio::error_code &ec) {
      ...
      // connections.
      asio::error_code
      listen(implementation_type &, int, asio::error_code &ec) {
        ec = asio::error::operation_not_supported;
        return ec;
      }
      ...
      asio::error_code
      non_blocking(implementation_type &, bool, asio::error_code &ec) {
        ec = asio::error::operation_not_supported;
        return ec;
      }
      ...
      asio::error_code
      native_non_blocking(implementation_type &, bool, asio::error_code &ec) {
        ec = asio::error::operation_not_supported;
        return ec;
      }
      ...
      asio::error_code
      bind(implementation_type &, const endpoint_type &, asio::error_code &ec) {
        ec = asio::error::operation_not_supported;
        return ec;
      }
      ...
      asio::error_code
      set_option(implementation_type &, const Option &, asio::error_code &ec) {
        ec = asio::error::operation_not_supported;
        return ec;
      }
      ...
      void async_accept(implementation_type &,
                        Socket &,
                        endpoint_type *,
                        Handler &handler) {
        asio::error_code ec = asio::error::operation_not_supported;
