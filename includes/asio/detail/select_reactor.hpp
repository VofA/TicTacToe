...
#include "asio/detail/config.hpp"
    ...
    (!defined(ASIO_HAS_DEV_POLL) && !defined(ASIO_HAS_EPOLL) && \
...
namespace asio {
  namespace detail {
    ...
    class select_reactor
      ...
      // Cancel all operations associated with the given descriptor. This
      // function does not acquire the select_reactor's mutex.
