  ...
  namespace detail {
    ...
    class reactive_socket_sendto_op_base : public reactor_op {
      ...
      reactive_socket_sendto_op_base(socket_type socket,
          ...
          : reactor_op(&reactive_socket_sendto_op_base::do_perform,
                       complete_func)
          , socket_(socket)
          , buffers_(buffers)
      ...
      static status do_perform(reactor_op *base) {
        ...
        ASIO_HANDLER_REACTOR_OPERATION(
            (*o, "non_blocking_sendto", o->ec_, o->bytes_transferred_));
    ...
    class reactive_socket_sendto_op
      ...
      static void do_complete(void *owner,
        ...
        reactive_socket_sendto_op *o(
            static_cast<reactive_socket_sendto_op *>(base));
