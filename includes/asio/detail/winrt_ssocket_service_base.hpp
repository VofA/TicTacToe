  ...
  namespace detail {
    ...
    class winrt_ssocket_service_base {
      ...
      struct base_implementation_type {
        // Default constructor.
        base_implementation_type() : socket_(nullptr), next_(0), prev_(0) {
        }
      ...
      // Constructor.
      ASIO_DECL winrt_ssocket_service_base(asio::io_context &io_context);
      ...
      ASIO_DECL native_handle_type release(base_implementation_type &impl,
                                           asio::error_code &ec);
      ...
      asio::error_code
      non_blocking(base_implementation_type &, bool, asio::error_code &ec) {
        ec = asio::error::operation_not_supported;
        return ec;
      }
      ...
      std::size_t send(base_implementation_type &,
                       const null_buffers &,
      ...
      void async_send(base_implementation_type &impl,
        ...
        ASIO_HANDLER_CREATION(
            (io_context_.context(), *p.p, "socket", &impl, 0, "async_send"));
      ...
      std::size_t receive(base_implementation_type &,
                          const null_buffers &,
                          socket_base::message_flags,
                          asio::error_code &ec) {
        ec = asio::error::operation_not_supported;
      ...
      void async_receive(base_implementation_type &impl,
        ...
        ASIO_HANDLER_CREATION(
            (io_context_.context(), *p.p, "socket", &impl, 0, "async_receive"));
      ...
      do_get_endpoint(const base_implementation_type &impl,
                      bool local,
                      void *addr,
                      std::size_t addr_len,
                      asio::error_code &ec) const;
      ...
      ASIO_DECL asio::error_code do_connect(base_implementation_type &impl,
                                            const void *addr,
                                            asio::error_code &ec);
      ...
      ASIO_DECL void
      start_receive_op(base_implementation_type &impl,
                       const asio::mutable_buffer &data,
                       socket_base::message_flags flags,
