...
namespace asio {
  namespace detail {
    ...
    class reactive_socket_service_base {
      ...
      // Constructor.
      ASIO_DECL reactive_socket_service_base(asio::io_context &io_context);
      ...
      do_assign(base_implementation_type &impl,
                int type,
                const native_handle_type &native_socket,
                asio::error_code &ec);

      // Start the asynchronous read or write operation.
      ASIO_DECL void start_op(base_implementation_type &impl,
                              int op_type,
                              reactor_op *op,
                              bool is_continuation,
