    ...
    namespace socket_option {
      ...
      class boolean {
        ...
        void resize(const Protocol &, std::size_t s) {
          // On some platforms (e.g. Windows Vista), the getsockopt function
          // will return the size of a boolean socket option as one byte, even
          // though a four byte integer was passed in.
          switch (s) {
            case sizeof(char):
