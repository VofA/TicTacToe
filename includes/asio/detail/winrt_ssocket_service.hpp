  ...
  namespace detail {
    ...
    class winrt_ssocket_service
      ...
      void converting_move_construct(
          ...
          typename winrt_ssocket_service<Protocol1>::implementation_type
              &other_impl) {
        this->base_move_construct(impl, other_impl);
      ...
      endpoint_type local_endpoint(const implementation_type &impl,
        ...
        endpoint.resize(
            do_get_endpoint(impl, true, endpoint.data(), endpoint.size(), ec));
        return endpoint;
      }
      ...
      endpoint_type remote_endpoint(const implementation_type &impl,
        ...
        endpoint_type endpoint;
        endpoint.resize(
            do_get_endpoint(impl, false, endpoint.data(), endpoint.size(), ec));
        return endpoint;
      }
      ...
      void async_connect(implementation_type &impl,
        ...
        ASIO_HANDLER_CREATION(
            (io_context_.context(), *p.p, "socket", &impl, 0, "async_connect"));
