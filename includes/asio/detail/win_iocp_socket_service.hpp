    ...
    class win_iocp_socket_service
      ...
      class native_handle_type {
        ...
        native_handle_type(socket_type s)
            : socket_(s), have_remote_endpoint_(false) {
        }

        native_handle_type(socket_type s, const endpoint_type &ep)
            : socket_(s), have_remote_endpoint_(true), remote_endpoint_(ep) {
        }
      ...
      void converting_move_construct(
          ...
          typename win_iocp_socket_service<Protocol1>::implementation_type
              &other_impl) {
        this->base_move_construct(impl, other_impl);
      ...
      void async_send_to(implementation_type &impl,
        ...
        ASIO_HANDLER_CREATION((
            io_context_, *p.p, "socket", &impl, impl.socket_, "async_send_to"));
      ...
      void async_accept(implementation_type &impl,
        ...
        start_accept_op(impl,
                        peer.is_open(),
                        p.p->new_socket(),
                        impl.protocol_.family(),
                        impl.protocol_.type(),
                        impl.protocol_.protocol(),
                        p.p->output_buffer(),
                        p.p->address_length(),
      ...
      void async_connect(implementation_type &impl,
        ...
        ASIO_HANDLER_CREATION((
            io_context_, *p.p, "socket", &impl, impl.socket_, "async_connect"));
