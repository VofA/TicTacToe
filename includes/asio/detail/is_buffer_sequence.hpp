...
namespace asio {
  ...
  namespace detail {
    ...
    template <typename T>
    struct buffer_sequence_memfns_derived : T, buffer_sequence_memfns_base {};
    ...
    char begin_memfn_helper(
        buffer_sequence_memfns_check<void (buffer_sequence_memfns_base::*)(),
    ...
    template <typename T>
    char max_size_memfn_helper(buffer_sequence_memfns_check<
    ...
    template <typename T>
    char capacity_memfn_helper(buffer_sequence_memfns_check<
                               void (buffer_sequence_memfns_base::*)(),
    ...
    template <typename T>
    char prepare_memfn_helper(buffer_sequence_memfns_check<
                              void (buffer_sequence_memfns_base::*)(),
    ...
    template <typename T>
    char consume_memfn_helper(buffer_sequence_memfns_check<
                              void (buffer_sequence_memfns_base::*)(),
    ...
    char buffer_element_type_helper(
        T *t,
        typename enable_if<is_convertible<decltype(*buffer_sequence_begin(*t)),
                                          Buffer>::value>::type *);
    ...
    char buffer_element_type_helper(
        ...
        typename enable_if<
            is_convertible<typename T::value_type, Buffer>::value>::type *);
    ...
    template <typename T>
    char
    mutable_buffers_type_typedef_helper(typename T::mutable_buffers_type *);
    ...
    struct is_buffer_sequence_class
        : integral_constant<bool,
                            sizeof(begin_memfn_helper<T>(0)) != 1 &&
                                ...
                                sizeof(buffer_element_type_helper<T, Buffer>(
                                    0, 0)) == 1> {};

    template <typename T, typename Buffer>
    struct is_buffer_sequence : conditional<is_class<T>::value,
    ...
    template <>
    struct is_buffer_sequence<mutable_buffer, const_buffer> : true_type {};

    template <>
    struct is_buffer_sequence<const_buffer, const_buffer> : true_type {};

    template <>
    struct is_buffer_sequence<const_buffer, mutable_buffer> : false_type {};
    ...
    template <typename T>
    struct is_dynamic_buffer : conditional<is_class<T>::value,
