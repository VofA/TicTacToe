...
namespace asio {
  namespace detail {
    ...
    class scheduler : public execution_context_service_base<scheduler>,
      ...
      // Constructor. Specifies the number of concurrent threads that are likely
      // to run the scheduler. If set to 1 certain optimisation are performed.
      ...
      // Request invocation of the given operations and return immediately.
      ...
      // Process unfinished operations as part of a shutdownoperation. Assumes
