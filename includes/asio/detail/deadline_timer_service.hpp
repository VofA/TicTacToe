  ...
  namespace detail {
    ...
    class deadline_timer_service
      ...
      void move_construct(implementation_type &impl,
        ...
        scheduler_.move_timer(
            timer_queue_, impl.timer_data, other_impl.timer_data);
      ...
      void move_assign(implementation_type &impl,
        ...
        other_service.scheduler_.move_timer(
            other_service.timer_queue_, impl.timer_data, other_impl.timer_data);
      ...
      std::size_t cancel(implementation_type &impl, asio::error_code &ec) {
        ...
        ASIO_HANDLER_OPERATION(
            (scheduler_.context(), "deadline_timer", &impl, 0, "cancel"));
      ...
      std::size_t cancel_one(implementation_type &impl, asio::error_code &ec) {
        ...
        ASIO_HANDLER_OPERATION(
            (scheduler_.context(), "deadline_timer", &impl, 0, "cancel_one"));

        std::size_t count =
            scheduler_.cancel_timer(timer_queue_, impl.timer_data, 1);
        if (count == 0)
          impl.might_have_pending_waits = false;
        ec = asio::error_code();
        return count;
      ...
      std::size_t expires_after(implementation_type &impl,
                                ...
                                asio::error_code &ec) {
        return expires_at(
            impl, Time_Traits::add(Time_Traits::now(), expiry_time), ec);
      }
      ...
      void wait(implementation_type &impl, asio::error_code &ec) {
        ...
        while (Time_Traits::less_than(now, impl.expiry) && !ec) {
          this->do_wait(Time_Traits::to_posix_duration(
                            Time_Traits::subtract(impl.expiry, now)),
                        ec);
          now = Time_Traits::now();
        }
      }
      ...
      void async_wait(implementation_type &impl, Handler &handler) {
        ...
        scheduler_.schedule_timer(
            timer_queue_, impl.expiry, impl.timer_data, p.p);
        p.v = p.p = 0;
      }
