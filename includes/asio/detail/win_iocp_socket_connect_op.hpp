...
namespace asio {
  namespace detail {
    ...
    class win_iocp_socket_connect_op_base : public reactor_op {
      public:
      win_iocp_socket_connect_op_base(socket_type socket,
                                      func_type complete_func)
          : reactor_op(&win_iocp_socket_connect_op_base::do_perform,
                       complete_func)
          , socket_(socket)
          , connect_ex_(false) {
      }
      ...
      static status do_perform(reactor_op *base) {
        ...
        return socket_ops::non_blocking_connect(o->socket_, o->ec_) ? done
                                                                    : not_done;
      }
    ...
    class win_iocp_socket_connect_op : public win_iocp_socket_connect_op_base {
      ...
      win_iocp_socket_connect_op(socket_type socket, Handler &handler)
          : win_iocp_socket_connect_op_base(
                socket, &win_iocp_socket_connect_op::do_complete)
