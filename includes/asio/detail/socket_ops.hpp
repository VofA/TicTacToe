...
namespace asio {
  namespace detail {
    namespace socket_ops {
      ...
      ASIO_DECL int bind(socket_type s,
                         const socket_addr_type *addr,
                         std::size_t addrlen,
                         asio::error_code &ec);

      ASIO_DECL int close(socket_type s,
                          state_type &state,
                          bool destruction,
                          asio::error_code &ec);
      ...
      ASIO_DECL int connect(socket_type s,
                            const socket_addr_type *addr,
                            std::size_t addrlen,
                            asio::error_code &ec);

      ASIO_DECL void sync_connect(socket_type s,
                                  const socket_addr_type *addr,
                                  std::size_t addrlen,
                                  asio::error_code &ec);
      ...
      ASIO_DECL int socketpair(int af,
                               int type,
                               int protocol,
                               socket_type sv[2],
                               asio::error_code &ec);
      ...
      ASIO_DECL signed_size_type recv(socket_type s,
                                      buf *bufs,
                                      size_t count,
                                      int flags,
                                      asio::error_code &ec);

      ASIO_DECL size_t sync_recv(socket_type s,
                                 state_type state,
                                 buf *bufs,
                                 size_t count,
                                 int flags,
      ...
      ASIO_DECL void
      complete_iocp_recv(state_type state,
      ...
      ASIO_DECL void
      complete_iocp_recvfrom(const weak_cancel_token_type &cancel_token,
                             asio::error_code &ec);
      ...
      ASIO_DECL signed_size_type recvmsg(socket_type s,
                                         buf *bufs,
                                         size_t count,
                                         int in_flags,
                                         int &out_flags,
      ...
      ASIO_DECL void
      complete_iocp_recvmsg(const weak_cancel_token_type &cancel_token,
                            asio::error_code &ec);
      ...
      ASIO_DECL signed_size_type send(socket_type s,
                                      const buf *bufs,
                                      size_t count,
                                      int flags,
                                      asio::error_code &ec);
      ...
      ASIO_DECL void
      complete_iocp_send(const weak_cancel_token_type &cancel_token,
                         asio::error_code &ec);
      ...
      ASIO_DECL socket_type socket(int af,
                                   int type,
                                   int protocol,
                                   asio::error_code &ec);
      ...
      ASIO_DECL int getsockopt(socket_type s,
                               state_type state,
                               int level,
                               int optname,
                               void *optval,
      ...
      ASIO_DECL int getpeername(socket_type s,
                                socket_addr_type *addr,
                                std::size_t *addrlen,
                                bool cached,
                                asio::error_code &ec);

      ASIO_DECL int getsockname(socket_type s,
                                socket_addr_type *addr,
                                std::size_t *addrlen,
                                asio::error_code &ec);

      ASIO_DECL int ioctl(socket_type s,
                          state_type &state,
                          int cmd,
                          ioctl_arg_type *arg,
                          asio::error_code &ec);

      ASIO_DECL int select(int nfds,
                           fd_set *readfds,
                           fd_set *writefds,
                           fd_set *exceptfds,
                           timeval *timeout,
      ...
      ASIO_DECL const char *inet_ntop(int af,
                                      const void *src,
                                      char *dest,
                                      size_t length,
      ...
      ASIO_DECL int inet_pton(int af,
                              const char *src,
                              void *dest,
                              unsigned long *scope_id,
                              asio::error_code &ec);
      ...
      background_getaddrinfo(const weak_cancel_token_type &cancel_token,
                             const char *host,
                             const char *service,
                             const addrinfo_type &hints,
                             addrinfo_type **result,
      ...
      ASIO_DECL asio::error_code sync_getnameinfo(const socket_addr_type *addr,
                                                  std::size_t addrlen,
                                                  char *host,
                                                  std::size_t hostlen,
                                                  char *serv,
      ...
      ASIO_DECL asio::error_code
      background_getnameinfo(const weak_cancel_token_type &cancel_token,
                             const socket_addr_type *addr,
                             std::size_t addrlen,
                             char *host,
                             std::size_t hostlen,
