  ...
  namespace detail {
    ...
    class reactive_socket_connect_op_base : public reactor_op {
      ...
      reactive_socket_connect_op_base(socket_type socket,
          ...
          : reactor_op(&reactive_socket_connect_op_base::do_perform,
                       complete_func)
          , socket_(socket) {
      }
      ...
      static status do_perform(reactor_op *base) {
        ...
        status result = socket_ops::non_blocking_connect(o->socket_, o->ec_)
                            ? done
                            : not_done;
    ...
    class reactive_socket_connect_op : public reactive_socket_connect_op_base {
      ...
      reactive_socket_connect_op(socket_type socket, Handler &handler)
          : reactive_socket_connect_op_base(
                socket, &reactive_socket_connect_op::do_complete)
