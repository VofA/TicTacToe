  ...
  namespace detail {
    namespace descriptor_ops {
      ...
      enum {
        ...
        // Helper "state" used to determine whether the descriptor is
        // non-blocking.
      ...
      ASIO_DECL std::size_t sync_read(int d,
                                      state_type state,
                                      buf *bufs,
                                      std::size_t count,
                                      bool all_empty,
      ...
      ASIO_DECL bool non_blocking_read(int d,
                                       buf *bufs,
                                       std::size_t count,
                                       asio::error_code &ec,
                                       std::size_t &bytes_transferred);

      ASIO_DECL std::size_t sync_write(int d,
                                       state_type state,
                                       const buf *bufs,
                                       std::size_t count,
                                       bool all_empty,
