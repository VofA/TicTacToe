...
namespace asio {
  namespace detail {
    ...
    class win_iocp_handle_service
      ...
      // Write the given data at the specified offset. Returns the number of
      // bytes written.
      template <typename ConstBufferSequence>
      size_t write_some_at(implementation_type &impl,
                           uint64_t offset,
                           const ConstBufferSequence &buffers,
                           asio::error_code &ec) {
      ...
      void async_write_some(implementation_type &impl,
        ...
        ASIO_HANDLER_CREATION((iocp_service_.context(),
                               *p.p,
                               "handle",
                               &impl,
                               reinterpret_cast<uintmax_t>(impl.handle_),
                               "async_write_some"));
      ...
      // Start an asynchronous write at a specified offset. The data being
      ...
      // received.
      template <typename MutableBufferSequence>
      size_t read_some_at(implementation_type &impl,
                          uint64_t offset,
                          const MutableBufferSequence &buffers,
                          asio::error_code &ec) {
      ...
      // Start an asynchronous read at a specified offset. The buffer for the
